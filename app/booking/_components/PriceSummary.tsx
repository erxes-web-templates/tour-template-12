      ...
      <CardContent className='space-y-6'>
        <div className='space-y-4'>
          ...
          <div className='flex justify-between items-center px-1'>
            ...
            <span className='font-black text-purple-600 bg-purple-50 px-3 py-1 rounded-full text-sm'>
              × {numberOfPeople}
            </span>
          </div>
          ...
          <div className='bg-gray-900 rounded-[24px] p-5 text-white shadow-xl shadow-gray-200 transition-transform hover:scale-[1.02] duration-300'>
            ...
            <div className='flex justify-between items-end'>
              ...
              <span className="text-[10px] font-bold text-purple-400 mb-1">VAT багтсан</span>
            </div>
          </div>
        </div>

        {/* Features Block */}
        <div className='bg-purple-50/50 rounded-[24px] p-5 border border-purple-100/50 space-y-3'>
          <div className="flex items-center gap-3">
            <ShieldCheck className="w-4 h-4 text-purple-600" />
            <span className="text-xs font-bold text-purple-900/80">Аюулгүй төлбөр тооцоо</span>
          </div>
          <div className="flex items-center gap-3">
            <Zap className="w-4 h-4 text-purple-600" />
            <span className="text-xs font-bold text-purple-900/80">Шууд баталгаажуулалт</span>
          </div>
          <div className="flex items-center gap-3">
            <HeadphonesIcon className="w-4 h-4 text-purple-600" />
            <span className="text-xs font-bold text-purple-900/80">24/7 Хэрэглэгчийн дэмжлэг</span>
          </div>
        </div>
      </CardContent>
    </Card>
